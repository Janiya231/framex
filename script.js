/* =========================================
   RESET & ROOT STYLES (FRAME X THEME)
========================================= */
* {
    margin: 0;
    padding: 0;
...
/* =========================================
   BACKGROUND GRAPHICS & GLOWS (RED & WHITE)
========================================= */
body::before {
    content: "";
    position: fixed;
...
.glow-one { background: #ff0033; top: -250px; left: -200px; }
.glow-two { background: #ffffff; bottom: -250px; right: -200px; }
...
.blob1 { width: 400px; height: 400px; background: #ff0033; top: -150px; left: -150px; animation: moveBlob 8s infinite alternate; }
.blob2 { width: 350px; height: 350px; background: #555555; right: -120px; top: 30%; animation: moveBlob2 10s infinite alternate; }
.blob3 { width: 300px; height: 300px; background: #ff3333; bottom: -120px; left: 40%; animation: moveBlob3 12s infinite alternate; }
...
.ring {
    ...
    padding: 3px;
    border-radius: 50%;
    background: linear-gradient(45deg, #ff0033, #ffffff, #880011, #ff3333);
    background-size: 300%;
...
.loading-progress { height: 100%; width: 0; background: linear-gradient(90deg, #ff0033, #ffffff); animation: loading 3s cubic-bezier(0.1, 0.85, 0.25, 1) forwards; }
...
.navbar {
    ...
    background: linear-gradient(90deg, rgba(255,0,51,.05), rgba(255,255,255,.05), rgba(136,0,17,.05));
...
.logo:hover {
    ...
    box-shadow: 0 0 20px #ff0033, 0 0 40px #ffffff;
}
...
.hello { color: #ff0033; letter-spacing: 4px; font-size: 12px; font-weight: 600; margin-bottom: 10px; }
.hero h1 { font-size: clamp(50px, 7vw, 100px); line-height: 0.9; letter-spacing: -3px; font-weight: 800; }
.gradient-text {
    background: linear-gradient(135deg, #ffffff 30%, #ff0033 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
}
.lastname { letter-spacing: 6px; font-size: 15px; color: #ff0033; margin-top: 5px; font-weight: 700; }
...
.primary-btn {
    background: linear-gradient(90deg, #ff0033, #aa0022);
    background-size: 200%;
    color: white;
}
.primary-btn:hover {
...
.secondary-btn:hover { background: #151515; transform: translateY(-5px); border-color: #ff0033; }
...
.profile-orb {
    ...
    border-radius: 50%;
    padding: 2px;
    background: linear-gradient(135deg, #ff0033, #ffffff, #880011);
...
.orb-inner img {
    ...
    object-fit: cover;
    border-radius: 50%;
    filter: drop-shadow(0 0 18px rgba(255, 0, 51, .25));
}
.floating-card {
...
.card-icon { font-size: 16px; color: #ff0033; }
...
.scroll-indicator span { width: 2px; height: 40px; background: linear-gradient(#ff0033, transparent); animation: scrollMove 2s infinite; }
...
.section-heading p { color: #ff0033; letter-spacing: 3px; font-size: 11px; font-weight: 600; margin-bottom: 12px; }
...
.skill-card:hover { transform: translateX(8px); border-color: #ff0033; background: rgba(255,0,51,0.02); }
.skill-card span { color: #ff0033; font-size: 12px; font-weight: 700; }
...
.projects-section::before { background: #ff0033; top: -100px; left: -100px; }
.projects-section::after { background: #ffffff; bottom: -100px; right: -100px; }
...
.project-card {
    ...
    min-height: 380px; background: rgba(15, 15, 15, 0.65); border-radius: 24px; overflow: hidden;
    cursor: pointer; transform-style: preserve-3d; transition: transform 0.5s ease, box-shadow 0.5s ease;
    border: 1px solid rgba(255,255,255,0.05);
}
.project-card::before {
    content: ""; position: absolute; inset: -1px;
    background: linear-gradient(45deg, #ff0033, #ffffff, #555555);
...
.project-card:hover {
    ...
    box-shadow: 0 20px 50px rgba(255, 0, 51, 0.15), 0 30px 60px rgba(255, 255, 255, 0.05);
}
.project-number {
...
.project-content h3 { font-size: 22px; margin-bottom: 10px; font-weight: 700; }
...
.project-tags span:hover {
    transform: translateY(-3px); background: #ff0033; color: #fff; box-shadow: 0 0 15px #ff0033;
}
...
.contact-bg {
    ...
    transform: translate(-50%, -50%); background: radial-gradient(circle, rgba(255, 0, 51, 0.08), transparent 75%);
...
.contact-form {
    ...
    background-image: linear-gradient(#0d0d0d, #0d0d0d), linear-gradient(135deg, #ff0033, #ffffff);
    background-origin: border-box; background-clip: padding-box, border-box;
    box-shadow: 0 20px 40px rgba(255, 0, 51, 0.05);
...
.input-group input:focus, .input-group textarea:focus {
    border-color: #ff0033; box-shadow: 0 0 15px rgba(255, 0, 51, 0.2); background: rgba(255,255,255,0.05);
}
.input-group label {
...
.input-group textarea:focus + label, .input-group textarea:valid + label {
    top: -10px; left: 12px; padding: 2px 8px; background: #0d0d0d; color: #ff0033; font-size: 12px; border-radius: 4px;
}
...
.send-btn {
    ...
    background: linear-gradient(90deg, #ff0033, #aa0022); background-size: 200%;
    transition: 0.4s ease; display: flex; align-items: center; justify-content: center; gap: 10px;
}
.send-btn:hover {
    transform: translateY(-4px); box-shadow: 0 15px 30px rgba(255, 0, 51, 0.3); background-position: right center;
}
...
.social-link.youtube:hover { background: #ff0033; border-color: #ff0033; box-shadow: 0 10px 22px rgba(255, 0, 51, .25); }
.social-link.facebook:hover { background: #1877f2; border-color: #1877f2; box-shadow: 0 10px 22px rgba(24, 119, 242, .25); }
.social-link.whatsapp:hover { background: #25d366; border-color: #25d366; box-shadow: 0 10px 22px rgba(37, 211, 102, .25); }
.social-link.instagram:hover { border-color: #e1306c; background: linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045); box-shadow: 0 10px 22px rgba(225, 48, 108, .25); }
.social-link.tiktok:hover { background: #111; border-color: #25f4ee; box-shadow: 3px 3px 0 #fe2c55, -3px -3px 0 #25f4ee; }
...
@media (max-width: 668px) {
    ...
    .card-one { top: 24px; left: 0; }
    .card-two { right: 0; bottom: 36px; }
...
@media (max-width: 380px) {
    ...
    .profile-orb { width: 210px; height: 210px; }
